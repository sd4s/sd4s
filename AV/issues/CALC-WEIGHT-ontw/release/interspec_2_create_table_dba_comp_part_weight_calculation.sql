...
--uk
alter table drop constraint INTERSPC.UK_WEIGHT_MAIN_COMP_PART_NO;
drop index INTERSPC.UK_WEIGHT_MAIN_COMP_PART_NO;
--UK incl. de tech_calculation_date zodat we output van meerdere runs in tabel op kunnen slaan !!!
create unique index INTERSPC.UK_WEIGHT_COMP_PART_NO  ON INTERSPC.DBA_WEIGHT_COMPONENT_PART (TECH_CALCULATION_DATE, MAINPART, PART_NO, COMPONENT_PART_NO, CHARACTERISTIC_ID, PATH) TABLESPACE SPECI
;
--
