...
TYPE TK_TABLE_TYPE IS TABLE OF utupustkdetails%ROWTYPE  INDEX BY BINARY_INTEGER;
P_TK_TAB TK_TABLE_TYPE;
P_TK_TAB_VALUE_LIST_TYPE  UNAPIGEN.VC1_TABLE_TYPE;
P_TK_NR_OF_ROWS INTEGER;
...
(a_applic            OUT    UNAPIGEN.VC20_TABLE_TYPE, /* VC20_TABLE_TYPE */
 ...
 a_fa                OUT    UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
...
(a_up_in             IN     NUMBER,                   /* LONG_TYPE */
 ...
 a_description       OUT    UNAPIGEN.VC40_TABLE_TYPE, /* VC40_TABLE_TYPE */
 a_fa                OUT    UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
 a_inherit_fa        OUT    UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
 a_nr_of_rows        IN OUT NUMBER)                   /* NUM_TYPE */
RETURN NUMBER;
...
(a_up                IN     NUMBER,                   /* LONG_TYPE */
 ...
 a_fa                IN     UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
 a_inherit_fa        IN     UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
 a_nr_of_rows        IN OUT NUMBER,                   /* NUM_TYPE */
...
(a_up_in            IN     NUMBER,                     /* LONG_TYPE */
 ...
 a_pref_name        OUT    UNAPIGEN.VC20_TABLE_TYPE,   /* VC20_TABLE_TYPE */
 a_pref_value       OUT    UNAPIGEN.VC40_TABLE_TYPE,   /* VC40_TABLE_TYPE */
 a_inherit_pref     OUT    UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
 a_applicable_obj   OUT    UNAPIGEN.VC40_TABLE_TYPE,   /* VC40_TABLE_TYPE */
 a_category         OUT    UNAPIGEN.VC40_TABLE_TYPE,   /* VC40_TABLE_TYPE */
 a_description      OUT    UNAPIGEN.VC255_TABLE_TYPE,  /* VC255_TABLE_TYPE */
 a_nr_of_rows       IN OUT NUMBER)                     /* NUM_TYPE */
...
(a_up             IN   NUMBER,                       /* LONG_TYPE */
 ...
 a_inherit_pref   IN   UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
...
(a_up_in            IN     NUMBER,                     /* LONG_TYPE */
 a_us_in            IN     VARCHAR2,                   /* VC20_TYPE */
 a_pref_tp_in       IN     VARCHAR2,                   /* VC20_TYPE */
 a_pref_name_in     IN     VARCHAR2,                   /* VC20_TYPE */
 a_up               OUT    UNAPIGEN.LONG_TABLE_TYPE,   /* LONG_TABLE_TYPE */
 a_us               OUT    UNAPIGEN.VC20_TABLE_TYPE,   /* VC20_TABLE_TYPE */
 a_pref_name        OUT    UNAPIGEN.VC20_TABLE_TYPE,   /* VC20_TABLE_TYPE */
...
(a_up_in             IN     NUMBER,                   /* LONG_TYPE */
 ...
 a_inherit_tk        OUT    UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
 a_nr_of_rows        IN OUT NUMBER)                   /* NUM_TYPE */
RETURN NUMBER;
...
(a_up                IN     NUMBER,                   /* LONG_TYPE */
 ...
 a_inherit_tk        IN     UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
 a_nr_of_rows        IN     NUMBER,                   /* NUM_TYPE */
 a_modify_reason     IN     VARCHAR2)                 /* VC255_TYPE */
RETURN NUMBER;
...
(a_up                IN     NUMBER,                   /* LONG_TYPE */
 ...
 a_valueseq          OUT    UNAPIGEN.NUM_TABLE_TYPE,  /* NUM_TABLE_TYPE */
...
(a_up                IN     NUMBER,                   /* LONG_TYPE */
 ...
 a_valueseq          IN     UNAPIGEN.NUM_TABLE_TYPE,  /* NUM_TABLE_TYPE */
...
(a_qualification    OUT    UNAPIGEN.CHAR1_TABLE_TYPE,  /* CHAR1_TABLE_TYPE */
 a_description      OUT    UNAPIGEN.VC40_TABLE_TYPE,   /* VC40_TABLE_TYPE */
 a_nr_of_rows       IN OUT NUMBER,                     /* NUM_TYPE */
 a_where_clause     IN     VARCHAR2)                   /* VC511_TYPE */
RETURN NUMBER;
...
(a_up                IN     NUMBER,                    /* LONG_TYPE */
 a_us                IN     VARCHAR2,                  /* VC20_TYPE */
 a_page_id           OUT    UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_page_description  OUT    UNAPIGEN.VC40_TABLE_TYPE,  /* VC40_TABLE_TYPE */
 a_page_tp           OUT    UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
...
(a_up                IN     NUMBER,                    /* LONG_TYPE */
 a_us                IN     VARCHAR2,                  /* VC20_TYPE */
 a_page_id_in        IN     VARCHAR2,                  /* VC20_TYPE */
 a_page_id           OUT    UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_tk                OUT    UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_tk_tp             OUT    UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_description       OUT    UNAPIGEN.VC40_TABLE_TYPE,  /* VC40_TABLE_TYPE */
 a_active            OUT    UNAPIGEN.CHAR1_TABLE_TYPE, /* CHAR1_TABLE_TYPE */
 a_icon_name         OUT    UNAPIGEN.VC255_TABLE_TYPE, /* VC255_TABLE_TYPE */
 a_icon_nbr          OUT    UNAPIGEN.NUM_TABLE_TYPE,   /* NUM_TABLE_TYPE */
 a_cmd_line          OUT    UNAPIGEN.VC255_TABLE_TYPE, /* VC255_TABLE_TYPE */
 a_nr_of_rows        IN OUT NUMBER,                    /* NUM_TYPE */
 a_where_clause      IN     VARCHAR2)                  /* VC511_TYPE */
RETURN NUMBER;
...
(a_up                      IN     NUMBER,                    /* LONG_TYPE */
 a_us                      IN     VARCHAR2,                  /* VC20_TYPE */
 a_page_id                 IN     UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_page_description        IN     UNAPIGEN.VC40_TABLE_TYPE,  /* VC40_TABLE_TYPE */
 a_page_tp                 IN     UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_active                  IN     UNAPIGEN.CHAR1_TABLE_TYPE, /* CHAR1_TABLE_TYPE */
 a_nr_of_rows              IN     NUMBER,                    /* NUM_TYPE */
 a_add2del_where_clause    IN     VARCHAR2)                  /* VC511_TYPE */
RETURN NUMBER;
...
(a_up                      IN     NUMBER,                    /* LONG_TYPE */
 ...
 a_active                  IN     UNAPIGEN.CHAR1_TABLE_TYPE, /* CHAR1_TABLE_TYPE */
 a_icon_name               IN     UNAPIGEN.VC255_TABLE_TYPE, /* VC255_TABLE_TYPE */
 a_icon_nbr                IN     UNAPIGEN.NUM_TABLE_TYPE,   /* NUM_TABLE_TYPE */
 a_cmd_line                IN     UNAPIGEN.VC255_TABLE_TYPE, /* VC255_TABLE_TYPE */
 a_nr_of_rows              IN     NUMBER,                    /* NUM_TYPE */
 a_add2del_where_clause    IN     VARCHAR2)                  /* VC511_TYPE */
RETURN NUMBER;
