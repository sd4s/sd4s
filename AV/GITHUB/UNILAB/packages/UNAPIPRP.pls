...
(a_object_tp              IN    VARCHAR2,                  /* VC4_TYPE */
 ...
 a_object_version         OUT   UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
...
(a_object_tp              IN    VARCHAR2,                  /* VC4_TYPE */
 ...
 a_used_object_version    OUT   UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_au                     OUT   UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_au_version             OUT   UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_value                  OUT   UNAPIGEN.VC40_TABLE_TYPE,  /* VC40_TABLE_TYPE */
 a_description            OUT   UNAPIGEN.VC40_TABLE_TYPE,  /* VC40_TABLE_TYPE */
...
(a_object_tp                IN        VARCHAR2,                 /* VC4_TYPE */
 ...
 a_used_object_version      IN        VARCHAR2,                 /* VC20_TYPE */
 a_au                       IN        UNAPIGEN.VC20_TABLE_TYPE, /* VC20_TABLE_TYPE */
 a_au_version               IN OUT    UNAPIGEN.VC20_TABLE_TYPE, /* VC20_TABLE_TYPE */
 a_value                    IN        UNAPIGEN.VC40_TABLE_TYPE, /* VC40_TABLE_TYPE */
 a_nr_of_rows               IN        NUMBER,                   /* NUM_TYPE */
...
FUNCTION InternalChangeObjectStatus       /* INTERNAL */
(a_object_tp          IN        VARCHAR2, /* VC4_TYPE */
 a_object_id          IN        VARCHAR2, /* VC20_TYPE */
 a_object_version     IN        VARCHAR2, /* VC20_TYPE */
 a_new_ss             IN        VARCHAR2, /* VC2_TYPE */
...
FUNCTION CheckElecSignature               /* INTERNAL */
...
(a_object_tp                  IN     VARCHAR2,                  /* VC4_TYPE */
 a_used_object_tp             IN     VARCHAR2,                  /* VC4_TYPE */
 a_object_id                  IN     VARCHAR2,                  /* VC20_TYPE */
 a_object_id_version          IN     VARCHAR2,                  /* VC20_TYPE */
 a_used_object_id             OUT    UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_used_object_id_version     OUT    UNAPIGEN.VC20_TABLE_TYPE,  /* VC20_TABLE_TYPE */
 a_description                OUT    UNAPIGEN.VC40_TABLE_TYPE,  /* VC40_TABLE_TYPE */
 a_nr_of_rows                 IN OUT NUMBER,                    /* NUM_TYPE */
 a_where_clause               IN     VARCHAR2)                  /* VC511_TYPE */
RETURN NUMBER;
