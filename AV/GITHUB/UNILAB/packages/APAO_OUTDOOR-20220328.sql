            ...
            THEN
               ...
               ELSE
                  ...
                  IF lvn_subsc_exists_in_ws=0 THEN
                    ...
                    --IF lvi_ret_code=UNAPIGEN.DBERR_SUCCESS THEN
					  begin
  					    LogError (lcs_function_name, 'NA SAVE1RQSAMPLE voor UPDATE SC.RQ voor subsample-id: ' || lvs_sub_sc_id||' dbeer-success: '||UNAPIGEN.DBERR_SUCCESS );
                        UPDATE UTSC SET RQ=lts_rq_tab(lvn_subsc_row) WHERE SC=lvs_sub_sc_id;
