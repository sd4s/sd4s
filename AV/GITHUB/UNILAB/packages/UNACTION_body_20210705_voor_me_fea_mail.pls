...
-- 31/05/2021  | PS       | Added function SC_A08 
--------------------------------------------------------------------------------
...
END RQ_A06;
--------------------------------------------------------------------------------
-- RQ_A08: Recheck all worksheets of current request
--------------------------------------------------------------------------------
...
CURSOR lvq_ws_check IS
    SELECT ws
      FROM utwsgkrequestcode
     WHERE requestcode = UNAPIEV.P_RQ;

BEGIN

   FOR lvr_ws_check IN lvq_ws_check LOOP
         l_ret_code       := UNAPIWSP.CANCELWS
                   (lvr_ws_check.ws,
