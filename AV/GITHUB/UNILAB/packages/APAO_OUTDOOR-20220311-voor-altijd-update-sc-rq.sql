...
BEGIN
    ...
    FOR lvr_rq_progid IN lvq_rq_progid(lvs_ws) LOOP --loop 1.1
        ...
        FOR lvr_worksheets_in_rq IN lvq_worksheets_in_rq(lvr_rq_progid.requestcode, lvr_rq_progid.subprogramid) LOOP --loop 1.2
            ...
            FOR lvr_ws_details IN lvq_subprogid_details(lvr_worksheets_in_rq.ws, lvr_rq_progid.requestcode) LOOP --loop 1.3 NOTE: lvr_worksheets_in_rq.ws contains the Outdoor-worksheet, avs_ws is the current prep-ws.
                lvd_loop1_3:=SYSDATE;
