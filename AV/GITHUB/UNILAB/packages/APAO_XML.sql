...
-- 30-06-2022 | PS        | add DECODE-construction around GENXML IN FINAL-WRITE-TO-XML
--                        | to DECODE AMPERSANDS in PIBS-XML files (supplier-name)
--------------------------------------------------------------------------------
...
BEGIN
   ...
   lv_xml_clob := dbms_xmlgen.convert( dbms_xmlgen.getXML(ctx), 1) ;
