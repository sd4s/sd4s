...
--
--************************************************************************************************
--OUDE VARIANT AT_UPD_RQ_WMS_INDOOR, ZONDER TE KIJKEN NAAR OVERRULEN OP REQUEST-NIVEAU...(VERVANGEN DD. 24-01-2022
--************************************************************************************************
--
...
--************************************************************************************************
--************************************************************************************************
--NIEUWE VARIANT VAN AT_UPD_RQ_WMS_INDOOR. (VANAF 24-01-2022) !!!!!!
--************************************************************************************************
--************************************************************************************************
...
BEGIN
   ...
   UNAPIGEN.LogError (lcs_function_name, 'INSERT-SEND-UTRQ-WMS-UPD-RQ-PREP VOOR AT_SENDWMS RQ: '||L_RQ);
...
/*
--GELIJKWAARDIGE TRIGGER VOOR OUTDOOR OP TABEL UTWS:
...
BEGIN
   ...
   --
   UNAPIGEN.LogError (lcs_function_name, 'INSERT-SEND-UTWS-WMS-UPD-WS-PREP VOOR AT_SENDWMS RQ: '||L_RQ||'-SC:'||L_SC);
   AT_WMS.AT_SENDWMS(REQ); 
   UNAPIGEN.LogError (lcs_function_name, 'INSERT-SEND-UTSC-WMS-UPD-WS-PREP VOOR AT_SENDWMS RQ: '||L_RQ||'-SC:'||L_SC);
   --
EXCEPTION
  WHEN OTHERS 
  THEN
