...
--We laten SYS/SYSTEM-passwords ongewijzid !!!

--ALTER USER SYSTEM IDENTIFIED BY "daystar2021" ;
--
...
BEGIN
  IF (IS_SERVERERROR(1017)) THEN
    ...
    then
	  BEGIN
        INSERT INTO UNILAB.dba_invalid_logon VALUES(SYS_CONTEXT('USERENV', 'AUTHENTICATED_IDENTITY')||'-'||sys_context ('userenv','OS_USER') , SYS_CONTEXT('USERENV', 'HOST')||'@'||sys_context('userenv','service_name') , SYSDATE);
	    COMMIT;
	  EXCEPTION
