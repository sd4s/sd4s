--*******************************************************************************************************
--Creatie views: AV_BHR_BOM_HEADER_PART_NO
--

--*******************************************************************************************************
--view met alle CURRENT-HEADERS incl. SAP-CODE
--*******************************************************************************************************
--Wordt alleen AD-HOC door DBA voor ontw/test-werk gebruikt !!!!
--Wordt gebruikt vanuit het AANROEP-FNC_BEPAAL-HEADER-GEWICHT script...
--
--Selectie criteria:
--Alle PARTNO die als BOM_HEADER in BOM_ITEM.partno voorkomen.
-- 
--*******************************************************************************************************
...
--Een TYRE mag zelf niet als bom-item-component-part voorkomen
--Soms komt in historie een band nog wel als component voor, deze uitsluiten.
--Voor alle overige PARTNO komen we deze ook gewoon als COMPONENT-PART in BOM-ITEM tegen !!!
--Daar hoeven we hier niet op te controleren. Zit ook in de FNC-BEPAAL-HEADER-GEWICHT-function !!
--
...
and   bh.revision   = (--BH.revision moet max-BH.revision zijn (nu we ook op historic selecteren...)
