...
create or replace procedure DBA_AANROEP_COMP_PART_GEWICHT (p_header_part_no        varchar2   := 'ALLE' 
                                                          ,p_header_frame_id       varchar2   := 'ALLE' 
													      ,p_aantal                number     := 999999999
														  ,p_show_incl_items_jn    varchar2   := 'N' 
                                                          ,p_insert_weight_comp_jn varchar2   := 'J'			)
DETERMINISTIC
AS
--AANROEP-procedure voor een selectie van alle COMPONENT-PARTS onder een BOM-HEADER/TYRE. 
...
--Dus:   exec DBA_AANROEP_COMP_PART_GEWICHT('ALLE' , 'ALLE' , 999999999, 'N' ,'J' );      --haal alle part-no van ENSCHEDE + HONGARY op.
--
