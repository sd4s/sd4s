...
--
--             P_HEADER_REVISION = Indien NULL/GEEN REVISION meegegen, dan wordt MAX-REVISION eerst opgehaald bij P_HEADER_PART-NO.
...
BEGIN
  ...
  then  
    ...
    dbms_output.put_line('HEADER-MAINPART: '||pl_header_part_no ||' revision: '||pl_header_revision||' show bom-items J/N: '||pl_show_incl_items_jn );
    dbms_output.put_line('**************************************************************************************************************');
  end if;
