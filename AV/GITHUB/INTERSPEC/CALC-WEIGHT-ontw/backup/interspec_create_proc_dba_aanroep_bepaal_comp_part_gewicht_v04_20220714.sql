...
--
--             P_AANTAL = aantal rows output, dit is alleen voor testdoeleinden, en werkt alleen bij gebruik van WILDCARDS/'ALLE' in partno of sap-no !!
--                        Als je 1 specifieke band met PARTNO/SAPNO opvraagt zal resultaat altijd maar 1 zijn.
--             P_SHOW_INCL_ITEMS_JN = J=Ja, N=Nee tonen van de componenten in de BOM-HEADER-STRUCTURE vanuit procedure DBA_BEPAAL_COMP_PART_GEWICHT !!!
