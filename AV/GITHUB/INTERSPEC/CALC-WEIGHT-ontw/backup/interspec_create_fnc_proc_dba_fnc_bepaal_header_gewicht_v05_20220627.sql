...
SET SERVEROUTPUT ON
declare
l_component_part             varchar2(100) := 'XGF_BU11S18N1'; --'EM_764';
l_component_part_eenheid_kg  number;
begin
  l_component_part_eenheid_kg := DBA_FNC_BEPAAL_HEADER_GEWICHT(p_header_part_no=>l_component_part, p_show_incl_items_jn=>'N');
