    ...
    BEGIN
      ...
      loop 
		...
		then
          ...
          THEN
			...
			then
              ...
              --
			ELSE
			  dbms_output.put_line(l_remark||' TYRE: '||l_mainpart||' kg:'||l_part_eenheid_kg);
        ...
        then
          ...
          dbms_output.put_line(l_remark||'PART: '||l_part_no||' COMP: '||l_component_part||' kg:'||l_component_part_eenheid_kg);
