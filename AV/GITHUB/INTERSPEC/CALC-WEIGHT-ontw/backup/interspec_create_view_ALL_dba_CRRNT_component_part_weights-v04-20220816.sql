--*********************************************************************************************
--*********************************************************************************************
--create views:   1.DBA_VW_CRRNT_BOM_ITEMS
--                2.DBA_VW_ALL_BOM_ITEMS
--                3.DBA_VW_CRRNT_WEIGHT_COMP_TYRES   --OUD, IS vervangen door 4.DBA_VW_CRRNT_WEIGHT_TYRES !!!
--                4.DBA_VW_CRRNT_WEIGHT_TYRES
--                5.DBA_VW_CRRNT_WEIGHT_COMP_PARTS
--                6.DBA_VW_CRRNT_WEIGHT_MATERIALS
--                7.DBA_VW_CRRNT_MAINPART_PARTS
--                8.DBA_VW_CRRNT_TYRE_COMP_WEIGHT
--
--*********************************************************************************************
--*********************************************************************************************
...
--*********************************************************************************************
--1.VIEW alle CURRENT BOM-ITEMS incl STATUS + MAX(REVISION)
--*********************************************************************************************
...
--*******************************************************************************************
--2.VIEW ALL BOM-ITEMS-REVISIONS incl STATUS + MAX(REVISION)
--*******************************************************************************************
