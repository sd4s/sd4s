...
create unique index INTERSPC.UK_WEIGHT_COMP_PART_NO  ON INTERSPC.DBA_WEIGHT_COMPONENT_PART (TECH_CALCULATION_DATE, MAINPART, PART_NO, ALTERNATIVE, COMPONENT_PART_NO, CHARACTERISTIC_ID, PATH) TABLESPACE SPECI ;
--
