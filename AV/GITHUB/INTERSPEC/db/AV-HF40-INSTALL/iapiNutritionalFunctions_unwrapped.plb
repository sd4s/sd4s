...
AS
   ...
   FUNCTION GETPERCENTRDABASEDONRAW(
      ASNUTREFTYPE               IN       IAPITYPE.NUTREFTYPE_TYPE,
      ANUNIQUEID                 IN       IAPITYPE.SEQUENCE_TYPE,
      ANMOPSEQUENCENO            IN       IAPITYPE.SEQUENCE_TYPE,
      ANROWID                    IN       IAPITYPE.SEQUENCE_TYPE,
   ...
   EXCEPTION
      ...
      THEN
         IAPIGENERAL.LOGERROR( GSSOURCE,
                               ...
                               SQLERRM );
         RETURN( IAPIGENERAL.SETERRORTEXT( IAPICONSTANTDBERROR.DBERR_GENFAIL ) );
   END GETPERCENTRDABASEDONRAW;

   
   FUNCTION GETPERCENTRDABASEDONROUNDED(
      ASNUTREFTYPE               IN       IAPITYPE.NUTREFTYPE_TYPE,
      ANUNIQUEID                 IN       IAPITYPE.SEQUENCE_TYPE,
      ANMOPSEQUENCENO            IN       IAPITYPE.SEQUENCE_TYPE,
      ANROWID                    IN       IAPITYPE.SEQUENCE_TYPE,
      ...
      ANLAYOUTREVISION           IN       IAPITYPE.REVISION_TYPE,
      ANCOLID                    IN       IAPITYPE.SEQUENCE_TYPE,
      ASOUTVAL                   OUT      IAPITYPE.NUMVAL_TYPE )
      RETURN IAPITYPE.ERRORNUM_TYPE
   IS
      ...
      LSMETHOD                      IAPITYPE.METHOD_TYPE := 'getPercentRDA';
      LNRETVAL                      IAPITYPE.ERRORNUM_TYPE;
      LNROUNDEDVALCLOB              IAPITYPE.CLOB_TYPE;
      LNTOTALVALROUNDED             IAPITYPE.NUMVAL_TYPE;
   ...
   BEGIN
      ...
      LNRETVAL := GETVALUECALCULATED( ASNUTREFTYPE,
                                      ANUNIQUEID,
                                      ANMOPSEQUENCENO,
                                      ANROWID,
                                      ANLAYOUTID,
      ...
      BEGIN
          LNTOTALVALROUNDED := TO_NUMBER(TO_CHAR(LNROUNDEDVALCLOB));
      EXCEPTION 
            WHEN OTHERS THEN
            IAPIGENERAL.LOGINFO( GSSOURCE,
                               LSMETHOD,
                               'Could not calculate result based on the rounded value: ' || TO_CHAR(LNROUNDEDVALCLOB),
                               IAPICONSTANT.INFOLEVEL_3 );
   ...
   EXCEPTION
      ...
      THEN
         IAPIGENERAL.LOGERROR( GSSOURCE,
                               ...
                               SQLERRM );
         RETURN( IAPIGENERAL.SETERRORTEXT( IAPICONSTANTDBERROR.DBERR_GENFAIL ) );
   END GETPERCENTRDABASEDONROUNDED;
   ...
   IS
      ...
      LSMETHOD                      IAPITYPE.METHOD_TYPE := 'getPercentRDA';
      LNRETVAL                      IAPITYPE.ERRORNUM_TYPE;
      LNPERCENTRDACALCULATION       IAPITYPE.NUMVAL_TYPE;
   BEGIN
      ...
      LNRETVAL := IAPIUSERPREFERENCES.GETUSERPREFERENCE( 'Nutritional Module',
                                                         'PercentRDACalculation',
                                                         LNPERCENTRDACALCULATION );
      ...
      THEN
        IAPIGENERAL.LOGERROR( GSSOURCE,
                              LSMETHOD,
                              'User preference <PercentRDACalculation> could not be found, results will be based on raw data.');
          LNPERCENTRDACALCULATION := 0;
      END IF;

      IF (LNPERCENTRDACALCULATION = 0)
      THEN
        LNRETVAL := GETPERCENTRDABASEDONRAW( ASNUTREFTYPE,
                                             ANUNIQUEID,
                                             ANMOPSEQUENCENO,
                                             ANROWID,
                                             ANLAYOUTID,
                                             ...
                                             ANOUTVAL );
      ELSE
        LNRETVAL := GETPERCENTRDABASEDONROUNDED( ASNUTREFTYPE,
                                                 ANUNIQUEID,
                                                 ANMOPSEQUENCENO,
                                                 ANROWID,
                                                 ANLAYOUTID,
