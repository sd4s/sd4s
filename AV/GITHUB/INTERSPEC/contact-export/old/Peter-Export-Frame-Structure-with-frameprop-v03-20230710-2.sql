...
CASE
WHEN 1 THEN lsNewStatusName := 'In Dev';
WHEN 2 THEN lsNewStatusName := 'Current';
WHEN 3 THEN lsNewStatusName := 'Historic';
WHEN 4 THEN lsNewStatusName := 'Obsolete';
WHEN 5 THEN lsNewStatusName := 'Used';
WHEN 6 THEN lsNewStatusName := 'Imported';
WHEN 7 THEN lsNewStatusName := 'Current Intl';
ELSE lsNewStatusName := NULL;
END CASE;
*/	  
