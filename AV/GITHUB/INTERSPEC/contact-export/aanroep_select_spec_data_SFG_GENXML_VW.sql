...
prompt RUN ONDERSTAANDE STATEMENTS ALTIJD VANUIT DIT SCRIPT, EN NIET HANDMATIG IN SQL*PLUS-SESSION.
PROMPT DAARMEE WORDEN ALLE OVERBODIGE REGELS IN OUTPUT-BESTAND AUTOMATISCH VERWIJDERD EN KOMT ER GOED XML-BESTAND UIT!!!
PROMPT 
prompt aanroep: @aanroep_select_spec_data_SFG_GENXML_VW.sql
...
/*
--*************************************************************
--dd. 06-06-2023 obv AANROEP-CAL-lijst PGO:
--*************************************************************
