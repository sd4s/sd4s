...
--5.BOM_FUNCTION(JSONB, JSONB)
--
--AFHANKELIJKHEDEN:    PCR_FUNCTION_CONVERSION
--
--*******************************************************************************************************************
...
(select	pl.part_no
	...
	--	bom_function
	,	sc_lims_dal.fnc_bom_function(i.properties, comp_k.keywords)
	,	i.properties
	--	hierarchy
	,	replace(to_char(i.item_number, 'FM0999'), '-0', '_')::ltree
	--	part_path
	,	sc_lims_dal.fnc_path2ltree(pl.part_no) || sc_lims_dal.fnc_path2ltree(i.component_part)
	--	function_path
	,	sc_lims_dal.fnc_path2ltree(sk.keywords #>> '{Function, 0}') || sc_lims_dal.fnc_path2ltree( sc_lims_dal.fnc_bom_function( i.properties, comp_k.keywords)	)
	--	parent part
...
select	t.part_no
	...
	--	part_path
	,	t.part_path || sc_lims_dal.fnc_path2ltree(i.component_part)
	--	function_path
	,	t.function_path	|| sc_lims_dal.fnc_path2ltree( sc_lims_dal.fnc_bom_function( i.properties, comp_k.keywords)	)
	,	t.component_part_no, t.component_revision
	--	contains_cycle
	,	t.part_path @ sc_lims_dal.fnc_path2ltxt( i.component_part)::ltxtquery
	--	calculated quantity
	,	i.quantity
...
--	spec_function
 ...
 ,      i.item_number::integer
--	bom_function
 ,      sc_lims_dal.fnc_bom_function(i.properties, part_k.keywords)
 ,      i.properties
	--	hierarchy
	,	replace(to_char(i.item_number, 'FM0999'), '-0', '_')::ltree
	--	part_path
	,	sc_lims_dal.fnc_path2ltree(pl.part_no)|| sc_lims_dal.fnc_path2ltree(i.part_no)
	--	function_path
	,	sc_lims_dal.fnc_path2ltree( sc_lims_dal.fnc_bom_function( i.properties, sk.keywords))
	--	child_part
	,	pl.part_no, pl.revision
	--	contains_cycle
...
select	t.part_no
	...
	,	t.hierarchy || replace(to_char(i.item_number, 'FM0999'), '-0', '_')::ltree
	--	part_path
	,	t.part_path || sc_lims_dal.fnc_path2ltree(i.part_no)
	--	function_path
	,	t.function_path	|| sc_lims_dal.fnc_path2ltree( sc_lims_dal.fnc_bom_function( i.properties, part_k.keywords)	)
	,	t.component_part_no, t.component_revision
	--	contains_cycle
	,	t.part_path @ sc_lims_dal.fnc_path2ltxt( i.part_no)::ltxtquery
from tree t
