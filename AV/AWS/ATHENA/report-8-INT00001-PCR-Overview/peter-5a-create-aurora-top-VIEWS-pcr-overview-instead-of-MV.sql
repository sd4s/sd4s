...
--1.sc_lims_dal.mv_pcr_overview					sc_lims_dal.vw_pcr_overview
--2.sc_lims_dal.mv_pcr_general_information		sc_lims_dal.vw_pcr_general_information
--3.sc_lims_dal.mv_pcr_1st_stage_components		sc_lims_dal.vw_pcr_1st_stage_components
--4.sc_lims_dal.mv_pcr_2nd_stage_components		sc_lims_dal.vw_pcr_2nd_stage_components


--***************************************************************************
--VIEW/MV USED IN OLD-ATHENA-REPORT !!!!!
--1.sc_lims_dal.mv_pcr_overview
--1.sc_lims_dal.vw_pcr_overview
...
--4.sc_lims_dal.vw_pcr_2nd_stage_components
											 , jsonb_build_object('function_path_query'
...
--CREATE VIEW BASED ON SC_INTERSPEC_ENS-tables USED IN TOP-VIEWS:

--####################################
--VW_BOM_HEADER
--####################################
DROP VIEW sc_lims_dal.vw_bom_header;
--
CREATE OR REPLACE VIEW sc_lims_dal.vw_bom_header
(part_no
,revision
,plant
,alternative
...
commit;
--
grant all on  sc_lims_dal.vw_bom_header                to usr_rna_readonly1;


--####################################
--VW_CLASS3
--####################################
DROP VIEW sc_lims_dal.vw_class3;
--
CREATE OR REPLACE VIEW sc_lims_dal.vw_class3
(class
,sort_desc
,description
,intl
...
,type
,status
from sc_interspec_ens.class3
;
commit;
--
grant all on  sc_lims_dal.vw_class3                to usr_rna_readonly1;
...
grant all on  sc_lims_dal.vw_class3                    to usr_rna_readonly1;
--real-top-views
grant all on  sc_lims_dal.vw_pcr_overview              to usr_rna_readonly1;
grant all on  sc_lims_dal.vw_pcr_general_information   to usr_rna_readonly1;
grant all on  sc_lims_dal.vw_pcr_1st_stage_components   to usr_rna_readonly1;
grant all on  sc_lims_dal.vw_pcr_2nd_stage_components   to usr_rna_readonly1;

grant SELECT ON ALL TABLES IN SCHEMA sc_lims_dal TO usr_rna_readonly1;
...
--*******************************************
--REVISION HISTORY:
--06-05-2024   replace view sc_interspec_ens.bom_header by sc_lims_dal.vw_bom_header
--*******************************************
CREATE OR REPLACE VIEW sc_lims_dal.vw_pcr_overview
AS 
WITH bom_properties AS (
SELECT ss.part_no
,      ss.revision
,      bh.plant
...
JOIN sc_lims_dal.vw_bom_header           bh USING (part_no, revision)
...
JOIN sc_lims_dal.vw_class3                c ON c.class = t_1.class3_id
...
SELECT  bom_properties.part_no  AS "Part no."
 ...
 ,  (((((bom_properties.bom -> 'Top'::text) -> 'General information'::text) -> '(none)'::text) -> 'Size'::text) -> 'Building method'::text) ->> 'Value'::text AS "Building method",
    ...
    (((((bom_properties.bom -> 'Vulcanized tyre'::text) -> 'Processing'::text) -> 'General'::text) -> 'default property group'::text) -> 'Curing critical point'::text) ->> 'Value'::text AS "Curing critical point",                          --missing in new
    ((((((bom_properties.bom -> 'Vulcanized tyre'::text) -> 'Processing'::text) -> 'General'::text) -> 'Curing settings (steam)'::text) -> 'Curing time (total)'::text) ->> 'Target'::text)::double precision AS "Curing time (steam)",        --missing in new
    ((((((bom_properties.bom -> 'Vulcanized tyre'::text) -> 'Processing'::text) -> 'General'::text) -> 'Curing settings (nitrogen)'::text) -> 'Curing time (total)'::text) ->> 'Target'::text)::double precision AS "Curing time (nitrogen)",  --missing in new
    ...
    ((((((bom_properties.bom -> 'Greentyre'::text) -> 'Properties'::text) -> '(none)'::text) -> 'Greentyre properties'::text) -> 'Number of capply layers'::text) ->> 'Target'::text)::double precision AS "No. capply layers",                 --missing in new
...
--TEST-QUERY
select * 
from sc_lims_dal.vw_pcr_overview vw
where vw."Plant" = 'ENS'
;
...
--
--***********************************************
DROP VIEW sc_lims_dal.vw_pcr_general_information;
--
CREATE OR REPLACE VIEW sc_lims_dal.vw_pcr_general_information
AS 
WITH bom_properties AS (
SELECT ss.part_no
,      ss.revision
...
JOIN sc_lims_dal.vw_class3             c ON c.class = t.class3_id
WHERE ss.status_type::text = 'CURRENT'::text 
AND (ss.status_code::text <> ALL (ARRAY['TEMP CRRNT'::character varying, 'CRRNT QR1'::character varying, 'CRRNT QR2'::character varying]::text[])) 
AND ss.frame_id::text = 'A_PCR'::text 
AND NOT ss.is_trial 
...
,   (((((bom_properties.bom -> 'Top'::text) -> 'General information'::text) -> '(none)'::text) -> 'Size'::text) -> 'Building method'::text) ->> 'Value'::text AS "Building method",
    ...
    (((((bom_properties.bom -> 'Top'::text) -> 'General information'::text) -> '(none)'::text) -> 'General tyre characteristics'::text) -> 'Productline'::text) ->> 'Value'::text AS "Product-line",
    (((((bom_properties.bom -> 'Top'::text) -> 'General information'::text) -> '(none)'::text) -> 'General tyre characteristics'::text) -> 'Category'::text) ->> 'Value'::text AS "Category",
	--new per dd. 25-04-2024
    (((((bom_properties.bom -> 'Top'::text) -> 'Labels and certification'::text) -> '(none)'::text) -> 'Labels Rolling resistance'::text) -> 'Europe'::text) ->> 'Label'::text AS "Rolling resistance",
    (((((bom_properties.bom -> 'Top'::text) -> 'Labels and certification'::text) -> '(none)'::text) -> 'Labels Noise'::text) -> 'Europe'::text) ->> 'Sound waves'::text AS "Tyre noise label",
    (((((bom_properties.bom -> 'Top'::text) -> 'Labels and certification'::text) -> '(none)'::text) -> 'Labels Noise'::text) -> 'Europe'::text) ->> 'Noise (dB)'::text AS "Tyre noise",
    (((((bom_properties.bom -> 'Top'::text) -> 'Labels and certification'::text) -> '(none)'::text) -> 'Labels Wet grip'::text) -> 'Europe'::text) ->> 'Label'::text AS "Wet grip index",
	--new per dd. 25-04-2024
    (((((bom_properties.bom -> 'Top'::text) -> 'Labels and certification'::text) -> '(none)'::text) -> 'Labels Rolling resistance'::text) -> 'EPREL EU Label'::text) ->> 'Label'::text AS "EPREL EU Rolling resistance Label",
    (((((bom_properties.bom -> 'Top'::text) -> 'Labels and certification'::text) -> '(none)'::text) -> 'Labels Noise'::text) -> 'EPREL EU Label'::text) ->> 'Sound label'::text AS "EPREL EU Tyre noise Label",
    (((((bom_properties.bom -> 'Top'::text) -> 'Labels and certification'::text) -> '(none)'::text) -> 'Labels Noise'::text) -> 'EPREL EU Label'::text) ->> 'Noise (dB)'::text AS "EPREL EU Tyre noise",
    (((((bom_properties.bom -> 'Top'::text) -> 'Labels and certification'::text) -> '(none)'::text) -> 'Labels Wet grip'::text) -> 'EPREL EU Label'::text) ->> 'Label'::text AS "EPREL EU Wet grip Label",
    --
    NULL::text AS "Client",
    ...
    (((((bom_properties.bom -> 'Vulcanized tyre'::text) -> 'Processing Gyongyoshalasz'::text) -> 'General'::text) -> 'default property group'::text) -> 'Curing critical point'::text) ->> 'Value'::text AS "GYO Curing critical point",
    --
...
--TEST-QUERY
select * 
from sc_lims_dal.vw_pcr_general_information vw
where vw."Plant" = 'ENS'
;
...
--
--***********************************************
CREATE OR REPLACE VIEW sc_lims_dal.vW_pcr_1st_stage_components
AS 
WITH bom_properties AS (
SELECT ss.part_no
,      ss.revision
...
--TEST-QUERY
select * 
from sc_lims_dal.vw_pcr_1st_stage_components vw
where vw."Plant" = 'ENS'
;
...
--
--***********************************************
CREATE OR REPLACE VIEW sc_lims_dal.vw_pcr_2nd_stage_components
AS 
WITH bom_properties AS (
SELECT ss.part_no
,      ss.revision
...
--TEST-QUERY
select * 
from sc_lims_dal.vw_pcr_2nd_stage_components vw
where vw."Plant" = 'ENS'
;
