...
-- DOEL: OM EENVOUDIGER EEN BOM-EXPLOSION UIT TE KUNNEN VOEREN TBV GEWICHTSBEREKENING !!
--***************************************************************************************
-- revision_history
-- 08-04-2024   Add column DENSITY_NUM_1 tbv VOLUME-CALCULATION !!
--***************************************************************************************
DROP MATERIALIZED VIEW  "INTERSPC"."MV_BOM_ITEM_COMP_HEADER" ;
PURGE RECYCLEBIN;
--
...
,      bi.ITEM_NUMBER       
,      bi.COMPONENT_PART    
,      bhc.revision        as COMP_REVISION
,      bi.COMPONENT_PLANT  as COMP_PLANT
,      bhc.alternative     as COMP_ALTERNATIVE
,      bhc.preferred       as COMP_PREFERRED
,      bhc.base_quantity   as comp_base_quantity   
,      shc.status          as COMP_STATUS
,      shc.issued_date     as COMP_ISSUED_DATE
,      shc.frame_id        as COMP_FRAME_ID
,      bi.QUANTITY        
,      bi.UOM  
,      bi.ch_1             as CHARACTERISTIC 
,      bi.num_1            as density
,      bi.num_5            as phr
from bom_item   bi
...
,      -1     COMP_STATUS
,      to_date('01-01-1900','dd-mm-yyyy')  as COMP_ISSUED_DATE
,      '-1'     COMP_FRAME_ID
,      bi.QUANTITY        
,      bi.UOM  
,      bi.ch_1             as CHARACTERISTIC 
...
COMMENT ON MATERIALIZED VIEW "INTERSPC"."MV_BOM_ITEM_COMP_HEADER"  IS 'snapshot table for snapshot INTERSPC.MV_BOM_ITEM_COMP_HEADER';
GRANT SELECT ON "INTERSPC"."MV_BOM_ITEM_COMP_HEADER" TO "AWSDWH";
