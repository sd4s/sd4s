...
--
--INTERSPC-Grant the additional following privilege for each replicated table when you are using a specific table list.
--
...
GRANT EXECUTE on DBMS_LOGMNR to SYSTEM, INTERSPC;
GRANT SELECT on V_$LOGMNR_LOGS to SYSTEM, INTERSPC;
GRANT SELECT on V_$LOGMNR_CONTENTS to SYSTEM, INTERSPC;
--GRANT SELECT on V$LOGMNR_LOGS to SYSTEM, INTERSPC;
--GRANT SELECT on V$LOGMNR_CONTENTS to SYSTEM, INTERSPC;
...
--********************************************************************************************************
--********************************************************************************************************
-- voorbeeld om supplemental-logging op table-level aan te zetten.
-- Dit doen we echter niet nu, maar pas later obv de inhoud van onze CONFIG-TABLE met een eigen procedure...
--********************************************************************************************************
--********************************************************************************************************
/*
...
--test
--start logminer first !! 
--dbms_logmnr.start_logmnr() 
SELECT SQL_REDO FROM V$LOGMNR_CONTENTS WHERE SEG_OWNER='INTERSPC' and SEG_NAME='HEADER'
