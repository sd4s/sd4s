...
and   sp.status_type in ('CURRENT')
;

--table-comment:
comment on VIEW sc_lims_dal_ai.ai_specification is 'Contains SPECIFICATION-HEADERS from PCR/TBR/OHT-tyres, only current revision.';
...
and   (   sp.property_id    in (965,705212,712615,705300,703424,705195)
      OR  sp.property_id    in (704651)
	  OR  sp.property_id    in (709538)
	  )
;
...
comment on COLUMN sc_lims_dal_ai.ai_specification_property.sequence_number             is 'sequence-number';
...
comment on COLUMN sc_lims_dal_ai.ai_specification_property.header_id                   is 'Property Header ID of the Frame Data';
comment on COLUMN sc_lims_dal_ai.ai_specification_property.header_revision             is 'revision-number of ther frame-header';
comment on COLUMN sc_lims_dal_ai.ai_specification_property.header_description          is 'property-header-name';
...
comment on COLUMN sc_lims_dal_ai.ai_specification_property.spec_value                  is 'Value of the property assigned to the Specification-property';
comment on COLUMN sc_lims_dal_ai.ai_specification_property.spec_value_s                is 'String-Value of the property assigned to the Specification-property';
...
and   (   spd.property_id    in (965,705212,712615,705300,703424,705195)
      OR  spd.property_id    in (704651)
	  OR  spd.property_id    in (709538)
	  )
;
...
--table-comment:
comment on VIEW sc_lims_dal_ai.ai_specification_bom_item   is 'Contains all revisions specification-bom_items related to PCR/TBR/OHT-tyres and components';
--column-comment:
