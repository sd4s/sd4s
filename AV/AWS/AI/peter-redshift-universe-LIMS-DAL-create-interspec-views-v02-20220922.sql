...
,workflow_group_description  --Full description of the Workflowgroup assigned to the Specification
,workflow_status             --Spec WF Status of the Spec Header
...
,      sh.int_part_no
,      sh.int_part_revision
,      sh.frame_id
,      sh.frame_rev
from sc_interspec_ens.specification_header sh
,    sc_interspec_ens.workflow_group       wg
,    sc_interspec_ens.work_flow            wf
,    sc_interspec_ens.status               st
,    sc_interspec_ens.class3               spt
where sh.workflow_group_id = wg.workflow_group_id
and   wf.work_flow_id      = wg.work_flow_id
...
--SELECTION: header-revision status-type=CURRENT !!
--************************************************************************************************************
