...
set copydirIS61="G:\Oracleprod_test\Backup\IS61"
set copydirREPM="G:\Oracleprod_test\Backup\REPM"
set copydirU611="G:\Oracleprod_test\Backup\U611"
::
...
ECHO VERWIJDEREN VAN BAK-FILE VAN UNILAB OUDER DAN 6  DAGEN VAN DE ORACLEPROD-TEST... 
ECHO ER PASSEN NIET 2X FULL-BACK OP ORACLEPROD-TEST, DUS VOOR HET MAKEN VAN NIEUWE FULL-EXPORT MOET DE VORIGE EERSTE VERWIJDERD WORDEN.
::pause
...
if exist %copydirIS61%  (
   ...
   ::xcopy E:\Backup\IS61\*.*  G:\Oracleprod_test\Backup\IS61  /D /S /Y /r
