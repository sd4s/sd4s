...
Ik heb nog een paar ip adressen “vertaald”
172.30.0.37         limsclient                 - noodzakelijk voor interface met meetinstrumenten
172.30.65.137       huawei y6                  – Geen idee!!
172.30.30.3         rossingh_02979.apollotyres.com – pc van Teunis. Nu van Wilfred? 
172.30.69.44        tc_qp01066.vredestein.com      – Geen idee
172.30.0.9          sapack.vredestein.com          – Geen idee
172.30.2.5          ensdmail01.vredestein.com      - Mailserver (maar hoe lang nog??)
172.16.0.5          ??                             – Oude mailserver???
...
--assign UNILAB-ACL voor de nieuwe MAILSERVER-MICROSOFT (dd. 08-02-2022)
BEGIN
dbms_network_acl_admin.assign_acl (
acl => 'mailserver_u_acl.xml',
host => 'apollotyres-com.mail.protection.outlook.com', 
...
WORDT op 08-02-2022:
interspec	def_email_ext			apollotyres.com		  (let op: DOMEIN ZONDER EEN "@" !!!!)
interspec	email_sender			interspec_PROD@apollotyres.com	
...
--update INTERSPC_CFG set parameter_data='18.208.22.77'               where parameter =  'mailhost'      ;   --AND parameter_data='18.208.22.77'   --AND parameter_data='172.30.2.5' ;

update interspc.INTERSPC_CFG set parameter_data='apollotyres.com'                             where parameter =  'def_email_ext'  ;   
update interspc.INTERSPC_CFG set parameter_data='interspec_PROD@apollotyres.com'              where parameter =  'email_sender'  ;   
...
SMTP_INTERVAL	(1/24)
SMTP_SENDER		unilab_PROD@apollotyres.com
...
update unilab.utsystem set setting_value='unilab_PROD@apollotyres.com'                  where setting_NAME =  'SMTP_SENDER' ;  
