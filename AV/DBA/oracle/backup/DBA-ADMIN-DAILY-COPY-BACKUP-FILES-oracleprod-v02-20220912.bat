...
@ECHO OFF
::If you use a local-dir via RDP (FOR example: "Z on BROEK_01981") 
::then find manually this disk via command: net use
::Result will be for example:  \\TSCLIENT\Z
net use Z: \\TSCLIENT\Z
...
ECHO ORACLEPROD: VERWIJDEREN VAN BAK-FILE VAN UNILAB OUDER DAN 6 DAGEN VAN DE ORACLEPROD... 
...
::if manually created via command: net use
...
:NOTTHERE
ECHO NOTTHERE-ERROR: LOCALDIR bestaat niet, IS is niet geinstalleerd...
ECHO NOTTHERE-ERROR: HF40 CAN ONLY BE AFTER INTERSPEC 6.7 IS INSTALLED CORRECTLY.
pause
exit
