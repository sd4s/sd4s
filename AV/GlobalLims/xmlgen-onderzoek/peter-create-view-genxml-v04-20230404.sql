...
select sh.part_no         part_no
 ...
 --, (select mc1.long_name from material_class mc1, itprcl pcl where pcl.part_no = sh.part_no and pcl.hier_level=1 and pcl.matl_class_id = mc1.identifier)            material_class_lvl1
 --, (select mc2.long_name from material_class mc2, itprcl pcl where pcl.part_no = sh.part_no and pcl.hier_level=2 and pcl.matl_class_id = mc2.identifier)            material_class_lvl2
 ...
 --join  specification_section sps   on sps.section_id      = spr.section_id     and sps.sub_section_id = spr.sub_section_id
...
, case      when sps.type = 2
 ...
 left outer join  material_class mc1    on mc1.identifier = prc1.matl_class_id 
 left outer join  material_class mc2    on mc2.identifier = prc2.matl_class_id 
 --join  class3                      on class3.class = part.part_type
